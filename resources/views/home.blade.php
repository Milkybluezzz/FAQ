...
<body class="bg-gray-100 font-roboto">
    ...
    <div class="dashboard-container">
        ...
        <div class="stats-container">
            ...
            <div class="stat-box-Daftar">
                <h2>Daftar Aplikasi</h2>
                @foreach($MostView as $index => $content)
                <p>{{$index+1}}. {{ $content['judul'] }} ({{ $content['jumlah_qna'] }})</p>
                @endforeach
                <p></p> 
            </div>
        </div>
    ...
    <section id="about" class="content-section relative">
        ...
        <div class="relative z-10 flex items-center justify-center">
            <h2 class="text-black text-3xl font-bold">Apa itu BandungAppFAQ ?</h2>
        </div>
    ...
    // Periksa status saat ini, apakah sedang ditampilkan atau disembunyikan
    if (answer.style.display === "none" || answer.style.display === "") {
        // Tampilkan elemen jika tersembunyi
        answer.style.display = "block";
    } else {
        // Sembunyikan elemen jika sedang ditampilkan
